...
- Check the text values of the `customizations.yaml` keys, they have to be setted between quotes. Example:
  ...
  Note that integers and booleans values are setted without quotes.
