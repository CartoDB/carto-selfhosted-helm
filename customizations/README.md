...
4. Grant your Workload Identity service account with BigQuery RW access to your Datawarehouse dataset or project.

5. Grant your service account with the following role `roles/iam.workloadIdentityUser`:
   ```bash
