...
| `importApi.resources.requests.memory`                  | Container memory requests in MiB                                                                                                  | `768Mi`                         |
...
| `cdnInvalidatorSub.resources.requests.memory`                  | Container memory requests in MiB                                                                                                  | `768Mi`                         |
...
| `workspaceSubscriber.resources.requests.memory`                  | Container memory requests in MiB                                                                                                     | `768Mi`                         |
