...
| `importApi.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `384`                           |
...
| `importApi.resources.limits.memory`                    | Container memory limits in MiB                                                                                                    | `512Mi`                         |
...
| `importWorker.nodeProcessMaxOldSpacePercentage`           | Memory percentage for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes | `75`                            |
| `importWorker.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `3072`                          |
...
| `mapsApi.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `1536`                          |
...
| `mapsApi.resources.limits.memory`                    | Container memory limits in MiB                                                                                                    | `2048Mi`                        |
| `mapsApi.resources.limits.cpu`                       | Container cpu limits in milliCPU cores                                                                                            | `1000m`                         |
...
| `sqlWorker.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `3072`                          |
...
| `sqlWorker.resources.limits.memory`                    | Container memory limits in MiB                                                                                                    | `4096Mi`                        |
| `sqlWorker.resources.limits.cpu`                       | Container cpu limits in milliCPU cores                                                                                            | `1000m`                         |
| `sqlWorker.resources.requests.memory`                  | Container memory requests in MiB                                                                                                  | `3072Mi`                        |
...
| `cdnInvalidatorSub.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `384`                           |
...
| `cdnInvalidatorSub.resources.limits.memory`                    | Container memory limits in MiB                                                                                                    | `512Mi`                         |
...
| `workspaceApi.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes    | `768`                           |
...
| `workspaceApi.resources.limits.memory`                    | Container memory limits in MiB                                                                                                    | `1024Mi`                        |
...
| `workspaceSubscriber.defaultNodeProcessMaxOldSpace`              | Default memory for node process max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes       | `384`                           |
...
| `workspaceSubscriber.resources.limits.memory`                    | Container memory limits in MiB                                                                                                       | `512Mi`                         |
