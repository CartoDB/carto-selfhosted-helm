...
| `commonConfiguration`       | Configuration in the form of env vars to all Carto deployments                          | `""`            |
| `commonSecretConfiguration` | Sensitive configuration in the form of env vars to all Carto deployments                | `""`            |

### accounts-www Deployment Parameters

| Name                                                | Description                                                                                           | Value                                        |
| --------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `accountsWww.image.registry`                        | accounts-www image registry                                                                           | `docker.io`                                  |
| `accountsWww.image.repository`                      | accounts-www image repository                                                                         | `gcr.io/carto-onprem-artifacts/accounts-www` |
...
| `accountsWww.image.debug`                           | Enable accounts-www image debug mode                                                                  | `false`                                      |
| `accountsWww.replicaCount`                          | Number of accounts-www replicas to deploy                                                             | `1`                                          |
| `accountsWww.containerPorts.http`                   | accounts-www HTTP container port                                                                      | `3000`                                       |
...
| `accountsWww.containerSecurityContext.runAsUser`    | Set accounts-www containers' Security Context runAsUser                                               | `1001`                                       |
| `accountsWww.containerSecurityContext.runAsNonRoot` | Set accounts-www containers' Security Context runAsNonRoot                                            | `true`                                       |
...
| Name                                              | Description                                                                                         | Value                                      |
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `importApi.image.registry`                        | import-api image registry                                                                           | `docker.io`                                |
| `importApi.image.repository`                      | import-api image repository                                                                         | `gcr.io/carto-onprem-artifacts/import-api` |
...
| `importApi.image.debug`                           | Enable import-api image debug mode                                                                  | `false`                                    |
...
| `importApi.containerSecurityContext.runAsUser`    | Set import-api containers' Security Context runAsUser                                               | `1001`                                     |
...
| Name                                                 | Description                                                                                            | Value                                         |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
| `importWorker.image.registry`                        | import-worker image registry                                                                           | `docker.io`                                   |
| `importWorker.image.repository`                      | import-worker image repository                                                                         | `gcr.io/carto-onprem-artifacts/import-worker` |
...
| `importWorker.image.debug`                           | Enable import-worker image debug mode                                                                  | `false`                                       |
...
| `importWorker.containerSecurityContext.runAsUser`    | Set import-worker containers' Security Context runAsUser                                               | `1001`                                        |
...
| Name                                           | Description                                                                                      | Value                                   |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------ | --------------------------------------- |
| `ldsApi.image.registry`                        | lds-api image registry                                                                           | `docker.io`                             |
| `ldsApi.image.repository`                      | lds-api image repository                                                                         | `gcr.io/carto-onprem-artifacts/lds-api` |
...
| `ldsApi.image.debug`                           | Enable lds-api image debug mode                                                                  | `false`                                 |
...
| `ldsApi.containerSecurityContext.runAsUser`    | Set lds-api containers' Security Context runAsUser                                               | `1001`                                  |
...
| Name                                            | Description                                                                                       | Value                                    |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `mapsApi.image.registry`                        | maps-api image registry                                                                           | `docker.io`                              |
| `mapsApi.image.repository`                      | maps-api image repository                                                                         | `gcr.io/carto-onprem-artifacts/maps-api` |
...
| `mapsApi.image.debug`                           | Enable maps-api image debug mode                                                                  | `false`                                  |
...
| `mapsApi.containerSecurityContext.runAsUser`    | Set maps-api containers' Security Context runAsUser                                               | `1001`                                   |
...
| Name                                           | Description                                                                                      | Value                                  |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------- |
| `router.image.registry`                        | router image registry                                                                            | `docker.io`                            |
| `router.image.repository`                      | router image repository                                                                          | `gcr.io/carto-onprem-artifacts/router` |
...
| `router.image.debug`                           | Enable router image debug mode                                                                   | `false`                                |
| `router.replicaCount`                          | Number of router replicas to deploy                                                              | `1`                                    |
| `router.containerPorts.http`                   | router HTTP container port                                                                       | `3000`                                 |
...
| `router.containerSecurityContext.runAsUser`    | Set router containers' Security Context runAsUser                                                | `1001`                                 |
| `router.containerSecurityContext.runAsNonRoot` | Set router containers' Security Context runAsNonRoot                                             | `true`                                 |
...
| Name                                                 | Description                                                                                            | Value                                         |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
| `workspaceApi.image.registry`                        | workspace-api image registry                                                                           | `docker.io`                                   |
| `workspaceApi.image.repository`                      | workspace-api image repository                                                                         | `gcr.io/carto-onprem-artifacts/workspace-api` |
...
| `workspaceApi.image.debug`                           | Enable workspace-api image debug mode                                                                  | `false`                                       |
...
| `workspaceApi.containerSecurityContext.runAsUser`    | Set workspace-api containers' Security Context runAsUser                                               | `1001`                                        |
| `workspaceApi.containerSecurityContext.runAsNonRoot` | Set workspace-api containers' Security Context runAsNonRoot                                            | `true`                                        |
...
| Name                                                        | Description                                                                                                   | Value                                                |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `workspaceSubscriber.image.registry`                        | workspace-subscriber image registry                                                                           | `docker.io`                                          |
| `workspaceSubscriber.image.repository`                      | workspace-subscriber image repository                                                                         | `gcr.io/carto-onprem-artifacts/workspace-subscriber` |
...
| `workspaceSubscriber.image.debug`                           | Enable workspace-subscriber image debug mode                                                                  | `false`                                              |
...
| `workspaceSubscriber.containerSecurityContext.runAsUser`    | Set workspace-subscriber containers' Security Context runAsUser                                               | `1001`                                               |
| `workspaceSubscriber.containerSecurityContext.runAsNonRoot` | Set workspace-subscriber containers' Security Context runAsNonRoot                                            | `true`                                               |
...
| Name                                                 | Description                                                                                            | Value                                         |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
| `workspaceWww.image.registry`                        | workspace-www image registry                                                                           | `docker.io`                                   |
| `workspaceWww.image.repository`                      | workspace-www image repository                                                                         | `gcr.io/carto-onprem-artifacts/workspace-www` |
...
| `workspaceWww.image.debug`                           | Enable workspace-www image debug mode                                                                  | `false`                                       |
| `workspaceWww.replicaCount`                          | Number of workspace-www replicas to deploy                                                             | `1`                                           |
| `workspaceWww.containerPorts.http`                   | workspace-www HTTP container port                                                                      | `3000`                                        |
...
| `workspaceWww.containerSecurityContext.runAsUser`    | Set workspace-www containers' Security Context runAsUser                                               | `1001`                                        |
| `workspaceWww.containerSecurityContext.runAsNonRoot` | Set workspace-www containers' Security Context runAsNonRoot                                            | `true`                                        |
...
| Name                                                     | Description                                             | Value                                        |
| -------------------------------------------------------- | ------------------------------------------------------- | -------------------------------------------- |
| `workspaceMigrations.image.registry`                     | workspace-db image registry                             | `docker.io`                                  |
| `workspaceMigrations.image.repository`                   | workspace-db image repository                           | `gcr.io/carto-onprem-artifacts/workspace-db` |
...
The above parameters map to the env variables defined in [carto/carto](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator). For more information please refer to the [carto/carto](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator) image documentation.
