...
| `accountsWww.autoscaling.minReplicas`                    | The minimal number of containters for the accounts-www deployment                                                            | `2`                             |
...
| `ldsApi.autoscaling.minReplicas`                    | The minimal number of containters for the workspldsace-api deployment                                                   | `2`                             |
...
| `mapsApi.autoscaling.maxReplicas`                    | The maximum number of containers for the maps-api deployment                                                             | `6`                             |
...
| `router.autoscaling.minReplicas`                    | The minimal number of containters for the router deployment                                                            | `2`                             |
...
| `workspaceApi.autoscaling.maxReplicas`                    | The maximum number of containers for the workspace-api deployment                                                             | `6`                             |
...
| `workspaceWww.autoscaling.minReplicas`                    | The minimal number of containters for the workspace-www deployment                                                            | `2`                             |
