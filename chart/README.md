...
| Name                                                   | Description                                                                                                                                                                                                                                   | Value |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| `customSecrets.googleMapsApiKey`                       | Google maps api-key value.                                                                                                                                                                                                                    |       |
| `customSecrets.googleMapsApiKey.value`                 | Value of the secret `Google maps api-key`. One of `customSecrets.googleMapsApiKey.value` or `customSecrets.googleMapsApiKey.existingSecret` could be defined.                                                                                 | `""`  |
| `customSecrets.googleMapsApiKey.existingSecret.name`   | Name of the pre-existent secret containing the `customSecrets.googleMapsApiKey.existingSecret.key`. If `customSecrets.googleMapsApiKey.value` is defined, this value is going to be ignored and not used.                                     | `""`  |
| `customSecrets.googleMapsApiKey.existingSecret.key`    | Key to find in `customSecrets.googleMapsApiKey.existingSecret.name` where the value of `customSecrets.googleMapsApiKey` is found. If `customSecrets.googleMapsApiKey.value` is defined, this value is going to be ignored and not used.       | `""`  |
| `customSecrets.awsAccessKeyId`                         | If AWS is used in self-hosted, the AccessKey Id.                                                                                                                                                                                              |       |
| `customSecrets.awsAccessKeyId.value`                   | Value of the secret `AccessKey Id` (Only required if AWS is used). One of `customSecrets.awsAccessKeyId.value` or `customSecrets.awsAccessKeyId.existingSecret` could be defined.                                                             | `""`  |
| `customSecrets.awsAccessKeyId.existingSecret.name`     | Name of the pre-existent secret containing the `customSecrets.awsAccessKeyId.existingSecret.key`. If `customSecrets.awsAccessKeyId.value` is defined, this value is going to be ignored and not used.                                         | `""`  |
| `customSecrets.awsAccessKeyId.existingSecret.key`      | Key to find in `customSecrets.awsAccessKeyId.existingSecret.name` where the value of `customSecrets.awsAccessKeyId` is found. If `customSecrets.awsAccessKeyId.value` is defined, this value is going to be ignored and not used.             | `""`  |
| `customSecrets.awsAccessKeySecret`                     | If AWS is used in self-hosted, the AccessKey Secret.                                                                                                                                                                                          |       |
| `customSecrets.awsAccessKeySecret.value`               | Value of the secret `AccessKey Secret` (Only required if AWS is used). One of `customSecrets.awsAccessKeySecret.value` or `customSecrets.awsAccessKeySecret.existingSecret` could be defined.                                                 | `""`  |
| `customSecrets.awsAccessKeySecret.existingSecret.name` | Name of the pre-existent secret containing the `customSecrets.awsAccessKeySecret.existingSecret.key`. If `customSecrets.awsAccessKeySecret.value` is defined, this value is going to be ignored and not used.                                 | `""`  |
| `customSecrets.awsAccessKeySecret.existingSecret.key`  | Key to find in `customSecrets.awsAccessKeySecret.existingSecret.name` where the value of `customSecrets.awsAccessKeySecret` is found. If `customSecrets.awsAccessKeySecret.value` is defined, this value is going to be ignored and not used. | `""`  |
...
| `cartoSecrets.googleServiceAccount`                     | The secret used by the app to connect to google services. This couldn't be changed.                                                                                                                                                              |           |
| `cartoSecrets.googleServiceAccount.value`               | Value of the secret used by the app to connect to google services. This couldn't be changed. One of `cartoSecrets.googleServiceAccount.value` or `cartoSecrets.googleServiceAccount.existingSecret` could be defined.                            | `""`      |
| `cartoSecrets.googleServiceAccount.existingSecret.name` | Name of the pre-existent secret containing the `cartoSecrets.googleServiceAccount.existingSecret.key`. If `cartoSecrets.googleServiceAccount.value` is defined, this value is going to be ignored and not used.                                  | `""`      |
| `cartoSecrets.googleServiceAccount.existingSecret.key`  | Key to find in `cartoSecrets.googleServiceAccount.existingSecret.name` where the value of `cartoSecrets.googleServiceAccount` is found. If `cartoSecrets.googleServiceAccount.value` is defined, this value is going to be ignored and not used. | `""`      |
