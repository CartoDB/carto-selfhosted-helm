...
| `ldsApi.nodeMaxOldSpacePercentage`                  | Memory percentage for node max-old-space-size param https://nodejs.org/api/cli.html#--max-old-space-sizesize-in-megabytes | `75`                            |
...
| `ldsApi.resources.limits.cpu`                       | Container cpu limits in cpu cores                                                                                         | `1000m`                         |
| `ldsApi.resources.requests.memory`                  | Container memory requests in MiB                                                                                          | `768Mi`                         |
| `ldsApi.resources.requests.cpu`                     | Container cpu requests in cpu cores                                                                                       | `350m`                          |
