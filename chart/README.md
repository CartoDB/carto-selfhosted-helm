...
| Name                              | Description                                                              | Value     |
| --------------------------------- | ------------------------------------------------------------------------ | --------- |
| `selfHostedDomain`                | CARTO Self Hosted domain                                                 | `""`      |
...
| `accountsWww.containerPorts.http`                   | accounts-www HTTP container port                                                                      | `80`                                  |
...
| `router.containerPorts.http`                   | router HTTP container port                                                                       | `80`                            |
| `router.containerPorts.https`                  | router HTTPS container port                                                                      | `443`                           |
...
| Name                                      | Description                                                                       | Value          |
| ----------------------------------------- | --------------------------------------------------------------------------------- | -------------- |
| `router.service.type`                     | router service type                                                               | `LoadBalancer` |
...
| `workspaceWww.containerPorts.http`                   | workspace-www HTTP container port                                                                      | `80`                                   |
...
| `externalDatabase.user`                           | non-root Username for CARTO Database                               | `carto`        |
| `externalDatabase.adminUser`                      | Database admin user                                                | `postgres`     |
